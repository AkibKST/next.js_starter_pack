...
const FAQS = [
  {
    ...
    a: "Simply browse our available technicians, select the service you need, pick a convenient time slot, and confirm your booking. It takes less than 2 minutes!",
  },
  {
    q: "Are your technicians verified?",
    a: "Yes! Every technician on FixItPro goes through a rigorous background check, skill verification, and certification review before joining our platform.",
  },
  {
    q: "What if I'm not satisfied with the service?",
    a: "We offer a 100% satisfaction guarantee. If you're not happy with the work, we'll send another technician at no extra cost or provide a full refund.",
  },
  {
    q: "How are the prices determined?",
    a: "Prices are transparent and based on the type of service, complexity, and duration. You'll always see the estimated cost before confirming a booking — no hidden fees.",
  },
  {
    q: "Can I cancel or reschedule a booking?",
    a: "Absolutely. You can cancel or reschedule up to 2 hours before the appointment at no charge. Late cancellations may incur a small fee.",
  },
  {
    q: "Do you offer emergency services?",
    a: "Yes! Pro and Enterprise plan members get access to our 24/7 emergency dispatch for urgent issues like burst pipes or electrical failures.",
  },
];
...
export default function HomePage() {
  ...
  useEffect(() => {
    // Load user preferences from localStorage (mock)
    const stored = localStorage.getItem("preferences_user-123");
    if (stored) {
      loadPreferences("user-123");
    }
  }, [loadPreferences]);
  ...
  return (
    <div className="home">
      ...
      <section className="hero">
        ...
        <div className="hero__content">
          ...
          <h1 className="hero__title">
            Find &amp; Hire{" "}
            <span className="hero__title-gradient">Expert Technicians</span> in
            Minutes
          </h1>

          <p className="hero__subtitle">
            FixItPro connects you with verified, top-rated professionals for
            plumbing, electrical, HVAC, painting and more — all backed by our
            satisfaction guarantee.
          </p>
      ...
      {/* ═══════════════════════════════════════
          SECTION 1.5 — PERSONALIZED FOR YOU
         ═══════════════════════════════════════ */}
      {preferences.selectedTopics && preferences.selectedTopics.length > 0 && (
        <section className="section personalized">
          <div className="section__container">
            <span className="section__badge">✨ Personalized Just For You</span>
            <h2 className="section__title">
              Your Preferred <span className="gradient-text">Services</span>
            </h2>
            <p className="section__subtitle">
              Based on your preferences, here are the services we recommend
            </p>

            <div className="services-grid">
              {AVAILABLE_TOPICS.filter((t: (typeof AVAILABLE_TOPICS)[0]) =>
                preferences.selectedTopics.includes(t.name),
              ).map((topic: (typeof AVAILABLE_TOPICS)[0]) => (
                <div
                  key={topic.name}
                  className="service-card personalized-card"
                >
                  <div className="service-card__icon text-4xl">
                    {topic.icon}
                  </div>
                  <h3 className="service-card__title">{topic.name}</h3>
                  <p className="service-card__desc">{topic.description}</p>
                  <Link
                    href={`/technicians?service=${topic.name}`}
                    className="service-card__link"
                  >
                    Find {topic.name} Experts
                    <svg
                      width="16"
                      height="16"
                      viewBox="0 0 24 24"
      ...
      <section className="section" id="services">
        <div className="section__container">
          ...
          <p className="section__subtitle">
            From routine maintenance to emergency repairs — we cover every home
            service you need.
          </p>
        ...
        <div className="section__container">
          <div className="about">
            <div className="about__text">
              ...
              <h2 className="section__title">
                Why Choose <span className="gradient-text">FixItPro</span>?
              </h2>
              <p className="about__desc">
                FixItPro was founded with a simple mission: make home services
                effortless. We believe everyone deserves quick access to
                trustworthy, skilled professionals — without the hassle of
                endless searching and uncertainty.
              </p>
              <div className="about__features">
                {[
                  {
                    icon: "✅",
                    text: "Background-checked & certified technicians",
                  },
                  ...
                  {
                    icon: "🛡️",
                    text: "100% satisfaction guarantee on every job",
                  },
                ].map((f) => (
              ...
              <Link href="/about" className="hero__btn hero__btn--primary mt-2">
                Learn More About Us
              </Link>
            </div>
        ...
        <div className="section__container">
          ...
          <div className="pricing-grid">
            {PRICING.map((p) => (
              <div
                key={p.name}
                className={`pricing-card ${p.highlighted ? "pricing-card--highlight" : ""}`}
              >
                {p.highlighted && (
                ...
                <Link
                  href="/register"
                  className={`pricing-card__btn ${p.highlighted ? "pricing-card__btn--primary" : ""}`}
                >
                  Get Started
                </Link>
              </div>
      ...
      <section className="section section--dark" id="faq">
        <div className="section__container section__container--sm">
          ...
          <p className="section__subtitle">
            Everything you need to know about hiring technicians through
            FixItPro.
          </p>
        ...
        <div className="section__container">
          ...
          <div className="contact">
            ...
            >
              ...
              <button
                type="submit"
                className="hero__btn hero__btn--primary w-full"
              >
                Send Message
              </button>
            </form>
      ...
      <section className="relative py-20 bg-linear-to-r from-indigo-600 to-purple-600 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center px-4">
          ...
          <p className="text-xl text-white/90 mb-12 max-w-2xl mx-auto">
            Join thousands of customers who trust FixItPro for their home
            service needs. Find the perfect technician for your project today.
          </p>

          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Link
              href="/services"
              className="px-8 py-4 bg-white text-indigo-600 font-bold rounded-lg hover:shadow-2xl hover:shadow-white/50 transition-all duration-300 hover:-translate-y-1"
            >
              Browse Services →
            </Link>
            <Link
              href="/technicians"
              className="px-8 py-4 bg-transparent border-2 border-white text-white font-bold rounded-lg hover:bg-white/10 transition-all duration-300 hover:-translate-y-1"
            >
              Find Technicians
            </Link>
          </div>
