    ...
    <footer className="footer">
      ...
      <div className="footer__cta">
        <div className="footer__cta-inner">
          <div className="footer__cta-text">
            ...
            <p>Join thousands of homeowners who trust FixItPro for all their service needs.</p>
          </div>
          <div className="footer__cta-actions">
            <Link href="/register" className="hero__btn hero__btn--primary">
              Create Free Account
            </Link>
            <Link href="/technicians" className="hero__btn hero__btn--ghost">
              Browse Technicians
            </Link>
          </div>
        </div>
          ...
          <div className="footer__grid">
            ...
            <div className="footer__brand-col">
              ...
              <p className="footer__brand-desc">
                Connecting homeowners with verified, top-rated technicians for all home service needs.
              </p>
              {/* Social icons */}
      ...
      <div className="footer__bottom">
        <div className="footer__container footer__bottom-inner">
          <p className="footer__copy">© {currentYear} FixItPro. All rights reserved.</p>
          <p className="footer__made">Made with 💜 for homeowners everywhere</p>
        </div>
      </div>
    </footer>
  );
